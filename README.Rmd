...
The `actigraph.sleepr` package implements four sleep scoring/detection algorithms: Sadeh [@Sadeh:1994aa], Cole-Kripke [@Cole:1992aa], Oakley [@Oakley:1997aa], and Tudor-Locke [@Tudor-Locke:2014aa], as well as two non-wear detection algorithms: Troiano [@Troiano:2008aa] and Choi [@Choi:2011aa].
