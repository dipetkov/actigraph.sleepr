...
The `actigraph.sleepr` package implements functions to read AGD files and to apply three standard sleep algorithms: Sadeh [@Sadeh:1994aa], Cole-Kripke [@Cole:1992aa] and Tudor-Locke [@Tudor-Locke:2014aa].
...
---
nocite: | 
  @Troiano:2008aa, @Choi:2011aa, @Tudor-Locke:2014aa, @Cole:1992aa, @Sadeh:1994aa
...
