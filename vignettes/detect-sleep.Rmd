...
ggplot(agdb_10s, aes(timestamp, axis1)) +
  geom_line() +
  labs(x = "", y = "movement (vertical direction)", title = 
...
plot_activity(agdb_sadeh, "axis1", color = "sleep") +
  labs(x = "", y = "movement (bounded at 300)", title =
       "For each epoch, Sadeh infers whether the subject is asleep (red) or awake (blue)") +
  scale_x_datetime(date_labels = "%I%p") +
  guides(color = FALSE)
```
...
plot_activity(agdb_colekripke, "axis1", color = "sleep") +
  labs(x = "", y = "movement (bounded at 300)", title =
       "For each epoch, Cole-Kripke infers whether the subject is asleep (red) or awake (blue)") +
  scale_x_datetime(date_labels = "%I%p") +
  guides(color = FALSE)
```
...
plot_activity_period(agdb_60s, periods_sleep, "axis1", 
                     ...
                     fill = "#AAAAAA") +
  scale_x_datetime(date_labels = "%I%p") +
  labs(x = "", y = "movement", title = 
        paste0("Tudor-Locke detects sleep periods in a series of sleep-scored epochs (Ws and Ss)\n",
